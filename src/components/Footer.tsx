    ...
    <footer className="bg-ink text-white/60 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-lg font-bold tracking-tight text-white">Rameelo</span>
            </div>
            <p className="text-sm leading-relaxed max-w-xs text-white/50">
              Connecting the South Asian community across the USA through Garba, Raas, and celebration. Find
              events, meet people, and keep the tradition alive.
            </p>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-white/30">
          <p>© {new Date().getFullYear()} Rameelo. Made with love for the diaspora.</p>
          <p>Built by FinityOne</p>
        </div>
      </div>
    </footer>
  );

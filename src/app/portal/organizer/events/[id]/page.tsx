...
function TierCard({ tier, idx, onChange, uploading }: {
      ...
      <div className="p-4 bg-white space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              {!tier._new && (
                <span className="font-mono text-[9px] text-peacock">Can increase</span>
              )}
            </div>
        ...
        {price > 0 && (
          <div className="rounded-xl bg-aubergine/5 border border-aubergine/12 px-4 py-3 flex items-center justify-between">
            <div>
              <p className="font-mono text-[9px] uppercase tracking-widest text-aubergine/50">Buyer pays</p>
              <p className="font-display font-bold text-aubergine text-lg">${buyerTotal(price)}</p>
            </div>
            <div className="text-right">
              <p className="font-mono text-[9px] uppercase tracking-widest text-ink-muted">Your payout</p>
...
export default function OrganizerEventEditPage() {
  ...
  const [saved, setSaved]       = useState<"event" | "tickets" | "all" | null>(null);
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="font-ui text-xs text-ink-muted truncate max-w-[200px]">{ev.title}</span>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6 space-y-4">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="font-ui text-sm text-ink-muted leading-relaxed">
                You&apos;re editing existing ticket tiers. Price or quantity changes will update your revenue projections — but <strong className="text-ink">don&apos;t worry</strong>, everything is recalculated instantly and stays perfectly accurate.
              </p>
            </div>
      ...
      <div className="grid lg:grid-cols-12 gap-5 items-start">
        ...
        <div className="lg:col-span-5 lg:sticky lg:top-6 space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-ivory-200 overflow-hidden">
            ...
            <div className="px-5 py-3 bg-marigold/6 border-b border-marigold/15 flex gap-2.5">
              ...
              <p className="font-ui text-xs text-ink-muted leading-relaxed">
                Price and quantity changes update your revenue projections instantly and stay perfectly accurate. Tiers cannot be deleted to preserve sales history.
              </p>
            </div>
          ...
          {/* Add tier button (repeated below for discoverability) */}

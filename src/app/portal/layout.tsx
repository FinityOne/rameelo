...
export default function PortalLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    const pageLabel =
      ...
      pathname === "/portal/group-orders"  ? "Group Orders" :
      pathname === "/portal/my-card"       ? "Garba Passport" :
    ...
    <div className="min-h-screen flex" style={{ backgroundColor: "#FCF9F2" }}>
      ...
      >
        ...
        <nav className="flex-1 px-3 py-4 overflow-y-auto space-y-0.5">
          ...
          {/* Organizer section — link out to separate organizer portal */}
          {(role === 'organizer' || role === 'admin') && (
            <>
              ...
              >
                <span className="shrink-0 text-white/30 group-hover:text-white/70">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                </span>
                <span className="font-ui font-medium text-sm flex-1">Organizer Portal</span>
          ...
          {/* Admin section — link out to separate admin portal */}
          {role === 'admin' && (
            <>
              ...
              >
                ...
                <span className="font-ui font-medium text-sm flex-1">Admin Portal</span>
                <svg className="w-3 h-3 text-white/20 group-hover:text-white/50 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                </svg>
              </Link>

...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    label: "Growth",
    items: [
      { href: "/organizer/marketing", label: "Marketing",
  ...
  },
  {
    ...
    label: "Money",
    items: [
      { href: "/organizer/financials", label: "Earnings & Payouts",
...
const PAGE_TITLES: Array<{ test: (p: string) => boolean; title: string }> = [
  ...
  { test: (p) => p === "/organizer/marketing",                     title: "Marketing" },
  { test: (p) => p === "/organizer/customers",                     title: "Customers" },
  { test: (p) => /^\/organizer\/customers\/[^/]+$/.test(p),       title: "Customer Detail" },
  { test: (p) => p === "/organizer/sales",                         title: "Analytics" },
  { test: (p) => p === "/organizer/financials",                    title: "Earnings & Payouts" },
  { test: (p) => p === "/organizer/payouts",                       title: "Earnings & Payouts" },
